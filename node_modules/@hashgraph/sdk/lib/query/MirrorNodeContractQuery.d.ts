...
export default class MirrorNodeContractQuery {
     ...
     * @returns {this}
     */
    setValue(value: import("long")): this;
    /**
     * @param {Long} gasLimit
     ...
     * @returns {this}
     */
    setGasLimit(gasLimit: import("long")): this;
    /**
     * @param {Long} gasPrice
     ...
     * @returns {this}
     */
    setGasPrice(gasPrice: import("long")): this;
    /**
     ...
     * @returns {this}
     */
    setBlockNumber(blockNumber: import("long")): this;
    /**
     * @returns {ContractId?}
     */
     ...
     * @returns {Long?}
     */
    get value(): import("long") | null;
    /**
     * @returns {Long?}
     */
    get gasLimit(): import("long") | null;
    /**
     * @returns {Long?}
     */
    get gasPrice(): import("long") | null;
    /**
     * @returns {Long?}
     */
    get blockNumber(): import("long") | null;
    /**
     *
     * @param {Client} client
     ...
     */
    performMirrorNodeRequest(client: Client, jsonPayload: object): Promise<AxiosResponse>;
    /**
     * @returns {object}
     */
