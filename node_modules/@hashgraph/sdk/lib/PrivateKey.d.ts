...
export default class PrivateKey extends Key {
     ...
     * @returns {Promise<PrivateKey>}
     */
    static fromMnemonic(mnemonic: Mnemonic | cryptography.Mnemonic | string, passphrase?: string): Promise<PrivateKey>;
    /**
     ...
     * @returns {AccountId}
     */
    toAccountId(shard: import("long") | number, realm: import("long") | number): AccountId;
    /**
     * @returns {string}
     */
    get type(): string;
