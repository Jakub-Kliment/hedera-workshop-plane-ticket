...
export default class TokenNftsUpdateTransaction extends Transaction {
     ...
     */
    static _fromProtobuf(transactions: HashgraphProto.proto.ITransaction[], signedTransactions: HashgraphProto.proto.ISignedTransaction[], transactionIds: TransactionId[], nodeIds: AccountId[], bodies: HashgraphProto.proto.ITransactionBody[]): TokenNftsUpdateTransaction;
    /**
     * @param {object} [props]
     ...
     * @returns {this}
     */
    setSerialNumbers(serialNumbers: import("long")[]): this;
    /**
     ...
     */
    protected override _makeTransactionData(): HashgraphProto.proto.ITokenUpdateNftsTransactionBody;
}
