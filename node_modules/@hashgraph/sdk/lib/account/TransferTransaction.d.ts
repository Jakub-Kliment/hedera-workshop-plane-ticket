...
export default class TransferTransaction extends AbstractTokenTransferTransaction {
     ...
     * @returns {TransferTransaction}
     */
    _addHbarTransfer(accountId: AccountId | string, amount: number | string | import("long") | LongObject | BigNumber | Hbar, isApproved: boolean): TransferTransaction;
    /**
     * @internal
     * @param {AccountId | string} accountId
     * @param {number | string | Long | LongObject | BigNumber | Hbar} amount
     * @returns {TransferTransaction}
     */
    addHbarTransfer(accountId: AccountId | string, amount: number | string | import("long") | LongObject | BigNumber | Hbar): TransferTransaction;
    /**
     * @internal
     * @param {AccountId | string} accountId
     * @param {number | string | Long | LongObject | BigNumber | Hbar} amount
     * @returns {TransferTransaction}
     */
    addApprovedHbarTransfer(accountId: AccountId | string, amount: number | string | import("long") | LongObject | BigNumber | Hbar): TransferTransaction;
    /**
